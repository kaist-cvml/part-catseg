...
class ObjCATSegEvaluator(SemSegEvaluator):
    """
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            self._evaluation_set = meta.obj_evaluation_set
        ...
        self.device = "cuda"
        self._num_classes = len(meta.obj_eval_classes)
        self._class_names = meta.obj_eval_classes
        ...
        obj_to_obj_in_part = {}
        for index, class_text in enumerate(meta.obj_classes):
            if class_text in meta.obj_eval_classes:
                obj_to_obj_in_part[index] = meta.obj_eval_classes.index(class_text)
            else:
                obj_to_obj_in_part[index] = self.ignore_label
        self.obj_to_obj_in_part = obj_to_obj_in_part
    ...
    def process(self, inputs, outputs):
        ...
        for input, output_org in zip(inputs, outputs):
            ...
            sem_seg_output = output_org["sem_seg"]
            ...
            gt_masks = input["instances"].gt_masks
            ...
            if len(gt_masks) == 0:
                ...
                # gt = self.obj_to_obj_in_part_map[gt.to(self.device).int()].cpu().numpy()
                gt = self.obj_to_obj_in_part_map[gt.int()].cpu().numpy()
            ...
            if self.visualize:
                ...
                vis_pred = visualizer_pred.draw_obj_sem_seg(pred)
                ...
                vis_gt = visualizer_gt.draw_obj_sem_seg(gt)
    ...
    def evaluate(self):
        ...
        results = OrderedDict({"obj_sem": res})
