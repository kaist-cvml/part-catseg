...
from .obj_part_cat_seg_model import Aggregator
...
class ObjPartCATSegPredictor(nn.Module):
    @configurable
    def __init__(
        self,
        *,
    ...
    def forward(self, x, vis_guidance, test_text=None):
        ...
        obj_out, specific_part_out, costs = self.transformer(
            x, 
        ...
        return obj_out, specific_part_out, costs
