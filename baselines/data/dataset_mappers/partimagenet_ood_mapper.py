...
from baselines.data.datasets.register_partimagenet_ood import CLASS_NAMES, OBJ_CLASS_NAMES

__all__ = ["PartImagenetOODDatasetMapper"]


# TODO:

class PartImagenetOODDatasetMapper:
    """
